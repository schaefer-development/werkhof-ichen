    ...
    <v-row>
      <v-col xs="12" sm="6" md="4">
        <v-card rounded="0" flat>
          <v-img class="white--text align-end" height="250px" src="/werkhof_01.jpg"></v-img>
          ...
          <v-card-text>
            ...
            <div class="text-right pb-10">
              <v-btn nuxt to="/ueber_mich/werkhof" depressed color="ichen_red white--text">Mehr</v-btn>
            </div>
        ...
        <v-card rounded="0" flat class="ichen_green">
          ...
          <v-card-text class="white--text">
            ...
            <div class="text-right pb-3">
              <v-btn nuxt to="/anfertigungen/leder" depressed color="ichen_red white--text">Mehr</v-btn>
            </div>
          </v-card-text>
        </v-card>
      </v-col>
